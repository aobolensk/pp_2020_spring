...
#ifndef MODULES_TASK_4_POLETUEVA_A_SORTING_SHELL_WITH_SIMPLE_MERGE_POLETUEVA_A_SORTING_SHELL_WITH_SIMPLE_MERGE_H_
#define MODULES_TASK_4_POLETUEVA_A_SORTING_SHELL_WITH_SIMPLE_MERGE_POLETUEVA_A_SORTING_SHELL_WITH_SIMPLE_MERGE_H_
#include <vector>
#include <utility>
...
std::vector<int> Shell_with_merge_std(const std::vector<int>& a, int n, int size);

#endif  // MODULES_TASK_4_POLETUEVA_A_SORTING_SHELL_WITH_SIMPLE_MERGE_POLETUEVA_A_SORTING_SHELL_WITH_SIMPLE_MERGE_H_
