...
#ifndef MODULES_TASK_4_ANTIPIN_A_MATRIX_MULTIPLICATION_STD_MATRIX_MULTIPLICATION_H_
#define MODULES_TASK_4_ANTIPIN_A_MATRIX_MULTIPLICATION_STD_MATRIX_MULTIPLICATION_H_
...
class SparseMatrix {
 public:
    ...
    friend void getParallelSTDMatrixMultiplication(const SparseMatrix<CCS>& A, const SparseMatrix<CCS>& B,
        SparseMatrix<CCS>* C, const int numThreads);
 private:
    friend void parallelForMatrix(const SparseMatrix<CRS>& A, const SparseMatrix<CCS>& B,
        std::vector<std::vector<double>>* a, std::vector<std::vector<size_t>>* b,
        const size_t thread_number, const size_t count_of_thread);
    std::vector<double> A;
...
#endif  // MODULES_TASK_4_ANTIPIN_A_MATRIX_MULTIPLICATION_STD_MATRIX_MULTIPLICATION_H_
