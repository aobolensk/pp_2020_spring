...
#ifndef MODULES_TASK_4_KRIUKOV_STRASSEN_ALGORITHM_STRASSEN_ALGORITHM_H_
#define MODULES_TASK_4_KRIUKOV_STRASSEN_ALGORITHM_STRASSEN_ALGORITHM_H_
...
std::vector<double> strassenMultiplication_NoCastToPowerOfTwo_std(const std::vector<double>& a,
                                                              const std::vector<double>& b, unsigned int sz);
...
#endif  // MODULES_TASK_4_KRIUKOV_STRASSEN_ALGORITHM_STRASSEN_ALGORITHM_H_
