...
#include <thread>
#include <vector>
#include "../../modules/task_4/obolenskiy_a_gaussian_image_filtering/gaussian_image_filtering.h"
...
Image gaussianFilter(const Image &a, int rows, int cols) {
    ...
    int chunkSize = rows / THREADS_COUNT;
    int rem = rows % THREADS_COUNT;
