...
#ifndef MODULES_TASK_2_SHEMETOV_P_SPARSE_MATRIX_CCS_COMPLEX_MULTI_MATRIX_H_
#define MODULES_TASK_2_SHEMETOV_P_SPARSE_MATRIX_CCS_COMPLEX_MULTI_MATRIX_H_
...
class SparseMatrixCCS {
 ...
 public :
    ...
    static SparseMatrixCCS
    MultiplySparseMatrixParallel(const SparseMatrixCCS &A,
                                 const SparseMatrixCCS &B);
...
#endif  //  MODULES_TASK_2_SHEMETOV_P_SPARSE_MATRIX_CCS_COMPLEX_MULTI_MATRIX_H_
