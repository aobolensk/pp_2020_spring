...
// // TEST(multi_matrix, TEST_TIME_WITH_LARGE_NUMBERS) {
...
// TEST(multi_matrix, TEST_EQUAL_NOT_RANDOM_CCS_MATRIX_EXAMPLE_2) {
//     std::vector<std::complex<double>> valueA {{4}, {3}, {5}, {3},
//                                               {7}};
//     std::vector<int> col_indexA {0, 1, 1, 0, 2};
//     std::vector<int> row_ptrA {0, 2, 3, 5};
//     SparseMatrixCCS A(3, 3, valueA, col_indexA, row_ptrA);

//     std::vector<std::complex<double>> valueB {{7}, {2}, {2}, {3}};
//     std::vector<int> col_indexB {0, 2, 1, 1};
//     std::vector<int> row_ptrB {0, 2, 3, 4};
//     SparseMatrixCCS B(3, 3, valueB, col_indexB, row_ptrB);

//     std::vector<std::complex<double>> valueExpect {{34}, {21}, {14},
//                                                    {10},{15}};
