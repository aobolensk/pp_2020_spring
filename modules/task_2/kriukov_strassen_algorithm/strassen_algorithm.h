...
#ifndef MODULES_TASK_2_KRIUKOV_STRASSEN_ALGORITHM_STRASSEN_ALGORITHM_H_
#define MODULES_TASK_2_KRIUKOV_STRASSEN_ALGORITHM_STRASSEN_ALGORITHM_H_
...
std::vector<double> strassenMultiplication_NoCastToPowerOfTwo_omp(const std::vector<double>& a,
                                                              const std::vector<double>& b, unsigned int sz);
...
#endif  // MODULES_TASK_2_KRIUKOV_STRASSEN_ALGORITHM_STRASSEN_ALGORITHM_H_
