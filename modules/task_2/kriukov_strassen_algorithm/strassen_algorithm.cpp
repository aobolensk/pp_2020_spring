...
#include <../../../modules/task_2/kriukov_strassen_algorithm/strassen_algorithm.h>
#include <omp.h>
#include <random>
#include <ctime>
#include <vector>
...
std::vector<double> strassenMultiplication_NoCastToPowerOfTwo_omp(const std::vector<double>& a_,
  ...
  if (a11.size() > 256) {
    ...
    #pragma omp sections
      {
        #pragma omp section
          p1 = strassenMultiplication_NoCastToPowerOfTwo_omp(sum(a11, a22, split_sz),
               sum(b11, b22, split_sz), split_sz);
        #pragma omp section
          p2 = strassenMultiplication_NoCastToPowerOfTwo_omp(sum(a21, a22, split_sz), b11, split_sz);
        #pragma omp section
          p3 = strassenMultiplication_NoCastToPowerOfTwo_omp(a11, diff(b12, b22, split_sz), split_sz);
        #pragma omp section
          p4 = strassenMultiplication_NoCastToPowerOfTwo_omp(a22, diff(b21, b11, split_sz), split_sz);
        #pragma omp section
          p5 = strassenMultiplication_NoCastToPowerOfTwo_omp(sum(a11, a12, split_sz),
                b22, split_sz);
        #pragma omp section
          p6 = strassenMultiplication_NoCastToPowerOfTwo_omp(diff(a21, a11, split_sz),
               sum(b11, b12, split_sz), split_sz);
        #pragma omp section
          p7 = strassenMultiplication_NoCastToPowerOfTwo_omp(diff(a12, a22, split_sz),
