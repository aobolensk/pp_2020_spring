...
\includegraphics[scale=0.75]{../../../../modules/reports/yasakova_a_jarvis_alg/picture.png}
\captionof{figure}{Иллюстрация алгоритма}
\vspace{1ex}
\end{center} 
...
\lstinputlisting[language=C++, caption=Последовательная версия. Заголовочный файл]{../../../../modules/task_1/yasakova_a_jarvis_alg/jarvis_alg.h}
\lstinputlisting[language=C++, caption=Последовательная версия. Cpp файл]{../../../../modules/task_1/yasakova_a_jarvis_alg/jarvis_alg.cpp}
\lstinputlisting[language=C++, caption=Последовательная версия. Тесты]{../../../../modules/task_1/yasakova_a_jarvis_alg/main.cpp}

\lstinputlisting[language=C++, caption=OpenMP версия. Заголовочный файл]{../../../../modules/task_2/yasakova_a_jarvis_alg/jarvis_alg.h}
\lstinputlisting[language=C++, caption=OpenMP версия. Cpp файл]{../../../../modules/task_2/yasakova_a_jarvis_alg/jarvis_alg.cpp}
\lstinputlisting[language=C++, caption=OpenMP версия. Тесты]{../../../../modules/task_2/yasakova_a_jarvis_alg/main.cpp}

\lstinputlisting[language=C++, caption=TBB версия. Заголовочный файл]{../../../../modules/task_3/yasakova_a_jarvis_alg/jarvis_alg.h}
\lstinputlisting[language=C++, caption=TBB версия. Cpp файл]{../../../../modules/task_3/yasakova_a_jarvis_alg/jarvis_alg.cpp}
\lstinputlisting[language=C++, caption=TBB версия. Тесты]{../../../../modules/task_3/yasakova_a_jarvis_alg/main.cpp}

\lstinputlisting[language=C++, caption=std::thread версия. Заголовочный файл]{../../../../modules/task_4/yasakova_a_jarvis_alg/jarvis_alg.h}
\lstinputlisting[language=C++, caption=std::thread версия. Cpp файл]{../../../../modules/task_4/yasakova_a_jarvis_alg/jarvis_alg.cpp}
\lstinputlisting[language=C++, caption=std::thread версия. Тесты]{../../../../modules/task_4/yasakova_a_jarvis_alg/main.cpp}
