...
TEST(RectangleIntegration, Double_Integral_1) {
  ...
  a = { {5, 17}, {21, 53}};
  int cuts = 50;
  EXPECT_NEAR(rectIntSequen(f1, a, cuts), 104704, 100);
}
...
TEST(RectangleIntegration, Double_Integral_2) {
  ...
  a = { {5, 20}, {1, 5}};
  int cuts = 50;
  EXPECT_NEAR(rectIntSequen(f2, a, cuts), 652.2891, 20);
}
...
TEST(RectangleIntegration, Triple_Integral_4) {
  ...
  a = { {15, 25}, {30, 45}, {-1, 0.5} };
int cuts = 50;
  EXPECT_NEAR(rectIntSequen(f4, a, cuts), 75251.8655, 200);
}
...
TEST(RectangleIntegration, Triple_Integral_5) {
  ...
  a = { {-32, 134}};
  int cuts = 50;
  EXPECT_NEAR(rectIntSequen(f5, a, cuts), 812956.0353, 200);
}
...
TEST(RectangleIntegration, Triple_Integral_6) {
  ...
  a = { {41, 117}, {-10, 13}};
  int cuts = 50;
  EXPECT_NEAR(rectIntSequen(f6, a, cuts), 89767.3084, 200);
}
