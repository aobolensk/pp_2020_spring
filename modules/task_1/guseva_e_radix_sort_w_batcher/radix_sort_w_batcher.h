...
#ifndef MODULES_TASK_1_GUSEVA_RADIX_SORT_W_BATCHER_RADIX_SORT_W_BATCHER_H_
#define MODULES_TASK_1_GUSEVA_RADIX_SORT_W_BATCHER_RADIX_SORT_W_BATCHER_H_
#include <vector>
...
#endif  // MODULES_TASK_1_GUSEVA_RADIX_SORT_W_BATCHER_RADIX_SORT_W_BATCHER_H_