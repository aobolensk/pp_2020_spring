...
TEST(multi_matrix, TEST_EQUAL_MULTIPLICATION_NOT_RANDOM_CCS_MATRIX) {
    ...
    SparseMatrixCCS result = SparseMatrixCCS::MultiplySparseMatrix(A,B).transpose();
...
TEST(multi_matrix, TEST_EQUAL_NOT_RANDOM_CCS_MATRIX_EXAMPLE_2) {
    ...
    std::vector<std::complex<double>> valueA {{4,6},{0,4},{3,7},{4,5},{3,0},{2,1}};
    ...
    std::vector<std::complex<double>> valueExpect {{-20},{-19,48},{1,18},{-36,24}};
