...
TEST(SparceMatrixMultiplication, can_convert_regular_matrix_to_csr) {
  ...
  ASSERT_NO_THROW(csrMat.matrixToCSR(mat));
}
...
TEST(SparceMatrixMultiplication, can_multimply_square_csr_matrices) {
  ...
  csrMat1.matrixToCSR(mat1);
  csrMat2.matrixToCSR(mat2);
  csrMat2.transpose();
...
int main(int argc, char **argv) {
  ...
  //std::vector<std::vector<std::complex<double>>> tmp1;
  //tmp = randomMatrix(10, 5);
  //tmp1 = randomMatrix(5, 12);
  ///*print(tmp);*/
  //
