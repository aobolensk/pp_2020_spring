...
TEST(Trapezoidal_Rule_tbb, function_Of_Two_Variables) {
    int n = 2;
...
TEST(Trapezoidal_Rule_tbb, function_Of_Two_Variables_With_Sqrt) {
    int n = 2;
    std::vector<std::pair<double, double>> boundaries(n);
    std::vector<int> partition(n);
    boundaries[0] = { 4, 10 }; partition[0] = 10;
...
TEST(Trapezoidal_Rule_tbb, function_Of_Three_Two_Variables) {
    int n = 3;
    std::vector<std::pair<double, double>> boundaries(n);
    std::vector<int> partition(n);
...
TEST(Trapezoidal_Rule_tbb, function_Of_Three_Two_Variables_With_Log10_And_Sqrt) {
    int n = 3;
    std::vector<std::pair<double, double>> boundaries(n);
    std::vector<int> partition(n);
...
TEST(Trapezoidal_Rule_tbb, function_Of_Three_Two_Variables_With_Exp_Cos_And_Sin) {
    int n = 3;
    std::vector<std::pair<double, double>> boundaries(n);
    std::vector<int> partition(n);
