...
#ifndef MODULES_TASK_3_SAVOSINA_A_SOBEL_SOBEL_H_
#define MODULES_TASK_3_SAVOSINA_A_SOBEL_SOBEL_H_
...
mask sobel_tbb(const mask& _img);

#endif  // MODULES_TASK_3_SAVOSINA_A_SOBEL_SOBEL_H_
